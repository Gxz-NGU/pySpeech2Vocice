...
#   author: yanmeng2
# 
# 非实时转写调用demo， 如有问题，欢迎在工单提问！
# 科大讯飞的官方web api python程序
...
# ——————————————————转写可配置参数————————————————
# 参数可在官网界面查看，根据需求可自行在gene_params方法里添加修改
# 转写类型
lfasr_type = 0
# 是否开启分词
...
if __name__ == '__main__':
    api = RequestApi(appid="5ca5aed7", secret_key="3dd43f9ed94381bb15509e95210ded9e", upload_file_path=r"E:\output\record.wav")
    api.all_api_request()
